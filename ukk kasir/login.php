...
if(isset($_POST['username'])) {
    ...
    if(mysqli_num_rows($cek) > 0){
        ...
        $_SESSION['user'] = $data;
        echo '<script>alert("selamat datang, jangan lupa logout setelah selesai menggunakan halaman ini");</script>';
    }else{

        echo '<script>alert("username/passowrd salah"); location.href="index.php"</script>';
    }
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>LoginAplikasi Kasir</title>
