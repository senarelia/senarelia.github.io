...
<div class="container-fluid">
                        ...
                        <a href="?page=pelanggan" clas="btn btn-danger">+ Kembali</a>
                       <hr>
                       ...
                       <form method="post">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <textarea name="alamat" rows="5" class="form-control"> <?php echo $data['alamt']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>No Telepon</td>
                                <td>:</td>
                                <td><input class="form-control" type="number" step="0" value="<?php echo $data['no_telepon']; ?>" name="nama_telepon"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td:</td>
